#ifndef INCLUDE_VNODE_INTERNAL_H
#define INCLUDE_VNODE_INTERNAL_H
...
*/
#include "bsd/sys/vnode_internal.h" //The source tells you what fields exist; the binary tells you where they are.
