#ifndef INCLUDE_FILEDESC_H
#define INCLUDE_FILEDESC_H
...
*/
#include "bsd/sys/filedesc.h" //The source tells you what fields exist; the binary tells you where they are.
